...
global.owner = process.env.OWNER_NUMBER  || '263781805564' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://relaxo12:<moto>@cluster0.z77sfvo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.sudo  =  process.env.SUDO || "263781805564" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || ''07_06_2024_SIGMA_MD_LFSJPSb9_MAHER_ZUBAIR,              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'Helix Bot',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Synthex`, // ADD YOUR NAME
